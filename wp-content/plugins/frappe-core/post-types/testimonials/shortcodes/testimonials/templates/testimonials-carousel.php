<div class="eltdf-testimonials-holder clearfix <?php echo esc_attr($holder_classes); ?>">
    <div class="eltdf-testimonials eltdf-owl-custom-slider eltdf-testimonials-main" <?php echo frappe_elated_get_inline_attrs( $data_attr ) ?>>
    ...
    <div class="eltdf-testimonial-image-nav eltdf-owl-custom-slider">
        <?php foreach ($pagination_images as $image) { ?>
            <div class="eltdf-testimonial-image"><?php echo frappe_elated_get_module_part( $image ); ?></div>
        <?php } ?>
    </div>
