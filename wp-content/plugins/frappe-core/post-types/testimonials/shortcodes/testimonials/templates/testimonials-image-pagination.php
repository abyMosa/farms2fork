<div class="eltdf-testimonials-holder clearfix <?php echo esc_attr($holder_classes); ?>">
    <div class="eltdf-testimonials eltdf-testimonials-image-pagination-inner" <?php echo frappe_elated_get_inline_attrs( $data_attr ) ?>>
    ...
    <ul id="eltdf-testimonial-pagination" class="clearfix" >
        <?php foreach ($pagination_images as $image) : ?>
            <li class="eltdf-tsp-item"> <?php echo frappe_elated_get_module_part( $image ); ?> </li>
        <?php endforeach; ?>
    </ul>
</div>