<?php
if ( ! function_exists( 'frappe_elated_init_google_fonts_array' ) ) {
    function frappe_elated_init_google_fonts_array() {
        ...
        $frappe_elated_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'frappe_elated_init_google_fonts_array');
}