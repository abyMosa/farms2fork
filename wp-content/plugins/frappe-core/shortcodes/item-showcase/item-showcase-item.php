<?php
namespace FrappeCore\CPT\Shortcodes\ItemShowcase;
...
class ItemShowcaseItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Item Showcase List Item', 'frappe-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						array(
							...
							'heading'     => esc_html__( 'Item Position', 'frappe-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Item Title', 'frappe-core' ),
							'admin_label' => true
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Item Target', 'frappe-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Item Title Tag', 'frappe-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Item Title Color', 'frappe-core' ),
							'dependency' => array( 'element' => 'item_title', 'not_empty' => true )
						),
						array(
							'type'       => 'textarea',
							'param_name' => 'item_text',
							'heading'    => esc_html__( 'Item Text', 'frappe-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'item_text_color',
							'heading'    => esc_html__( 'Item Text Color', 'frappe-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = frappe_core_get_shortcode_module_template_part( 'templates/item-showcase-item', 'item-showcase', '', $params );
