<?php
namespace FrappeCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'frappe-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'frappe-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'frappe-core' ) => 'grid',
								esc_html__( 'Masonry', 'frappe-core' )    => 'masonry',
								esc_html__( 'Slider', 'frappe-core' )     => 'slider',
								esc_html__( 'Carousel', 'frappe-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							'type'        => 'attach_images',
							'param_name'  => 'images',
							'heading'     => esc_html__( 'Images', 'frappe-core' ),
							'description' => esc_html__( 'Select images from media library', 'frappe-core' )
						),
						array(
							'type'        => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Custom Links', 'frappe-core' ),
							'description' => esc_html__( 'Delimit links by comma', 'frappe-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Columns', 'frappe-core' ),
							'value'       => array(
								esc_html__( 'Two', 'frappe-core' )   => 'two',
								esc_html__( 'Three', 'frappe-core' ) => 'three',
								esc_html__( 'Four', 'frappe-core' )  => 'four',
								esc_html__( 'Five', 'frappe-core' )  => 'five',
								esc_html__( 'Six', 'frappe-core' )   => 'six'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'frappe-core' ),
							'value'       => array(
								esc_html__( 'One', 'frappe-core' )   => '1',
								esc_html__( 'Two', 'frappe-core' )   => '2',
								esc_html__( 'Three', 'frappe-core' ) => '3',
								esc_html__( 'Four', 'frappe-core' )  => '4',
								esc_html__( 'Five', 'frappe-core' )  => '5',
								esc_html__( 'Six', 'frappe-core' )   => '6'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'frappe-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'frappe-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'frappe-core' ),
							'value'       => array_flip( frappe_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'frappe-core' )
						...
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'frappe-core' ),
							'description' => esc_html__( 'Default value is 5000 (ms)', 'frappe-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'frappe-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Slide Animation Duration', 'frappe-core' ),
							'description' => esc_html__( 'Speed of slide animation in milliseconds. Default value is 600.', 'frappe-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'frappe-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'frappe-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'frappe-core' ),
							'value'       => array_flip( frappe_elated_get_yes_no_select_array( false ) ),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'frappe-core' ),
							'value'       => array_flip( frappe_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'frappe-core' )
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'frappe-core' ),
							'value'       => array_flip( frappe_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'frappe-core' )
	...
	public function render( $atts, $content = null ) {
		...
		$html = frappe_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
