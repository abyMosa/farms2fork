...
<div class="eltdf-image-gallery <?php echo esc_attr($holder_classes); ?>">
	<div class="eltdf-ig-slider eltdf-owl-slider" <?php echo frappe_elated_get_inline_attrs($slider_data); ?>>
			...
			<div class="eltdf-ig-image">
				...
				<?php } ?>
					<?php if(is_array($image_size) && count($image_size)) :
						echo frappe_elated_generate_thumbnail($image['image_id'], null, $image_size[0], $image_size[1]);
					else:
