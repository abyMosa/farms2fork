<?php
namespace FrappeCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'frappe-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'frappe-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'frappe-core' ),
							'value'      => array(
								esc_html__( '80/20', 'frappe-core' ) => '80',
								esc_html__( '75/25', 'frappe-core' ) => '75',
								esc_html__( '66/33', 'frappe-core' ) => '66',
								esc_html__( '50/50', 'frappe-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px)', 'frappe-core' ),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'simple' ) ),
							'group'      => esc_html__( 'Button Style', 'frappe-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'button_type',
							'heading'     => esc_html__( 'Button Type', 'frappe-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'frappe-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Link', 'frappe-core' ),
							'group'      => esc_html__( 'Button Style', 'frappe-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'button_target',
							'heading'    => esc_html__( 'Button Link Target', 'frappe-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Color', 'frappe-core' ),
							'group'      => esc_html__( 'Button Style', 'frappe-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_color',
							'heading'    => esc_html__( 'Button Hover Color', 'frappe-core' ),
							'group'      => esc_html__( 'Button Style', 'frappe-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_background_color',
							'heading'    => esc_html__( 'Button Background Color', 'frappe-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'frappe-core' ),
							'group'      => esc_html__( 'Button Style', 'frappe-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_border_color',
							'heading'    => esc_html__( 'Button Border Color', 'frappe-core' ),
							'group'      => esc_html__( 'Button Style', 'frappe-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'frappe-core' ),
							'group'      => esc_html__( 'Button Style', 'frappe-core' )
						),
						array(
							'type'       => 'textarea_html',
							'param_name' => 'content',
							'heading'    => esc_html__( 'Content', 'frappe-core' ),
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'frappe-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = frappe_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . frappe_elated_filter_px( $params['button_top_margin'] ) . 'px';
		}
