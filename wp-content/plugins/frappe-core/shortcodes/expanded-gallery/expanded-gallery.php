<?php
namespace FrappeCore\CPT\Shortcodes\ExpandedGallery;
...
class ExpandedGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Expanded Gallery', 'frappe-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Images', 'frappe-core' ),
							'value'       => array(
						...
						array(
							...
							'description' => esc_html__( 'Select images from media library. Images needs to be same size', 'frappe-core' )
						),
						array(
							'type'        => 'textarea',
	...
	public function render( $atts, $content = null ) {
		...
		$html = frappe_core_get_shortcode_module_template_part( 'templates/expanded-gallery', 'expanded-gallery', '', $params );
