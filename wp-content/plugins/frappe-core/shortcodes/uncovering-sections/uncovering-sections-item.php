<?php
namespace FrappeCore\CPT\Shortcodes\UncoveringSections;
...
class UncoveringSectionsItem implements Lib\ShortcodeInterface {
	...
	function __construct() {
		$this->base = 'eltdf_uncovering_sections_item';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Uncovering Sections Item', 'frappe-core' ),
					'base'            => $this->base,
					'as_child'        => array( 'only' => 'eltdf_uncovering_sections' ),
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Position', 'frappe-core' ),
							'description' => esc_html__( 'Please insert position in format horizontal vertical position, example - center center', 'frappe-core' ),
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'background_size',
							'heading'     => esc_html__( 'Background Image Size', 'frappe-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'frappe-core' )   => 'cover',
								esc_html__( 'Contain', 'frappe-core' ) => 'contain',
								esc_html__( 'Inherit', 'frappe-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'padding',
							'heading'     => esc_html__( 'Content Padding', 'frappe-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. You can use px or %', 'frappe-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'vertical_alignment',
							'heading'     => esc_html__( 'Content Vertical Alignment', 'frappe-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'frappe-core' ),
							'value'       => array(
								esc_html__( 'Default', 'frappe-core' ) => '',
						...
						array(
							...
							'description' => esc_html__( 'Set custom link around item', 'frappe-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Header Skin', 'frappe-core' ),
							'value'       => array(
								esc_html__( 'Default', 'frappe-core' ) => '',
								esc_html__( 'Light', 'frappe-core' )   => 'light',
								esc_html__( 'Dark', 'frappe-core' )    => 'dark'
							),
							'save_always' => true,
							'description' => esc_html__( 'Choose a predefined header style for header elements', 'frappe-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_laptop',
							'heading'     => esc_html__('Background Image for Laptops', 'frappe-core'),
							'group'       => esc_html__('Responsiveness', 'frappe-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'frappe-core'),
							'group'       => esc_html__('Responsiveness', 'frappe-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'frappe-core'),
							'group'       => esc_html__('Responsiveness', 'frappe-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'frappe-core'),
							'group'       => esc_html__('Responsiveness', 'frappe-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = frappe_core_get_shortcode_module_template_part( 'templates/uncovering-sections-item', 'uncovering-sections', '', $params );
