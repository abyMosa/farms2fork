<?php
namespace FrappeCore\CPT\Shortcodes\PricingTable;
...
class PricingTable implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Pricing Table', 'frappe-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						array(
							...
							'value'       => array(
								esc_html__( 'One', 'frappe-core' )   => 'eltdf-one-column',
								esc_html__( 'Two', 'frappe-core' )   => 'eltdf-two-columns',
								esc_html__( 'Three', 'frappe-core' ) => 'eltdf-three-columns',
								esc_html__( 'Four', 'frappe-core' )  => 'eltdf-four-columns',
								esc_html__( 'Five', 'frappe-core' )  => 'eltdf-five-columns',
							),
							'save_always' => true
						),
						array(
