...
/**
 * Class FrappeInstagramHelper
 */
class FrappeInstagramHelper {
    /**
     * Generates HTML for given image from Instagram feed. Defines frappe_instagram_image_atts filter
    ...
    public function getImageHTML($image, $imageSize) {
        ...
        $imageAtts = apply_filters('frappe_instagram_image_atts',
            array(
                'class' => $imageSize,
