...
include 'frappe-instagram-helper.php';

/**
 * Class FrappeInstagramApi
 */
class FrappeInstagramApi {
    /**
    ...
    private $apiURL;
    /**
     * @var FrappeInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var FrappeInstagramHelper
     */
    private $helper;

    const CODE_OPTION_NAME = 'frappe_instagram_code';
    const USER_ID_OPTION_NAME = 'frappe_instagram_user_id';
    const ACCESS_TOKEN_OPTION_NAME = 'frappe_instagram_access_token';
    const CODE_REDIRECT_URI_OPTION_NAME = 'frappe_instagram_code_redirect_uri';
    ...
    private function __construct() {
        ...
        $this->helper = new FrappeInstagramHelper();
    }
     ...
     * @return string
     *
     * @see FrappeInstagramApi::buildCurrentPageURI()
     */
     ...
     *
     * @see FrappeInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see FrappeInstagramApi::getAccessToken()
     */
