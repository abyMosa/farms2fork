...
if ( ! function_exists( 'frappe_elated_fonts_options_map' ) ) {
	/**
	 * Font options page
	 */
	function frappe_elated_fonts_options_map() {
		
		frappe_elated_add_admin_page(
			array(
				'slug'  => '_fonts_page',
				'title' => esc_html__( 'Fonts', 'frappe' ),
				'icon'  => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = frappe_elated_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_headings',
				'title' => esc_html__( 'Headings', 'frappe' )
			)
		);
		
		//H1
		$group_heading_h1 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_heading_h1',
				'title'       => esc_html__( 'H1 Style', 'frappe' ),
				'description' => esc_html__( 'Define styles for h1 heading', 'frappe' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h1_1 = frappe_elated_add_admin_row(
			array(
		...
		frappe_elated_add_admin_field(
			array(
				...
				'args'          => array(
					'suffix' => esc_html__( 'px / em', 'frappe' )
				),
				'parent'        => $row_heading_h1_1
			)
		);
		...
		$row_heading_h1_2 = frappe_elated_add_admin_row(
			array(
		...
		$row_heading_h1_3 = frappe_elated_add_admin_row(
			array(
		...
		frappe_elated_add_admin_field(
			array(
				...
				'name'          => 'h1_margin_top',
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'frappe' ),
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'frappe' ),
				'parent'        => $row_heading_h1_3
			)
		);
		
		//H2
		$group_heading_h2 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_heading_h2',
				'title'       => esc_html__( 'H2 Style', 'frappe' ),
				'description' => esc_html__( 'Define styles for h2 heading', 'frappe' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h2_1 = frappe_elated_add_admin_row(
			array(
		...
		$row_heading_h2_2 = frappe_elated_add_admin_row(
			array(
		...
		$row_heading_h2_3 = frappe_elated_add_admin_row(
			array(
		...
		//H3
		$group_heading_h3 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_heading_h3',
				'title'       => esc_html__( 'H3 Style', 'frappe' ),
				'description' => esc_html__( 'Define styles for h3 heading', 'frappe' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h3_1 = frappe_elated_add_admin_row(
			array(
		...
		$row_heading_h3_2 = frappe_elated_add_admin_row(
			array(
		...
		$row_heading_h3_3 = frappe_elated_add_admin_row(
			array(
		...
		//H4
		$group_heading_h4 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_heading_h4',
				'title'       => esc_html__( 'H4 Style', 'frappe' ),
				'description' => esc_html__( 'Define styles for h4 heading', 'frappe' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h4_1 = frappe_elated_add_admin_row(
			array(
		...
		$row_heading_h4_2 = frappe_elated_add_admin_row(
			array(
		...
		$row_heading_h4_3 = frappe_elated_add_admin_row(
			array(
		...
		//H5
		$group_heading_h5 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_heading_h5',
				'title'       => esc_html__( 'H5 Style', 'frappe' ),
				'description' => esc_html__( 'Define styles for h5 heading', 'frappe' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h5_1 = frappe_elated_add_admin_row(
			array(
		...
		$row_heading_h5_2 = frappe_elated_add_admin_row(
			array(
		...
		$row_heading_h5_3 = frappe_elated_add_admin_row(
			array(
		...
		//H6
		$group_heading_h6 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_heading_h6',
				'title'       => esc_html__( 'H6 Style', 'frappe' ),
				'description' => esc_html__( 'Define styles for h6 heading', 'frappe' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h6_1 = frappe_elated_add_admin_row(
			array(
		...
		$row_heading_h6_2 = frappe_elated_add_admin_row(
			array(
		...
		$row_heading_h6_3 = frappe_elated_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings3 = frappe_elated_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings3',
				'title' => esc_html__( 'Headings Responsive (Tablet Landscape View)', 'frappe' )
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h1',
				'title'       => esc_html__( 'H1 Responsive Style', 'frappe' ),
				'description' => esc_html__( 'Define responsive styles for h1 heading', 'frappe' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h1_3 = frappe_elated_add_admin_row(
			array(
		...
		//H2
		$group_responsive3_heading_h2 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h2',
				'title'       => esc_html__( 'H2 Responsive Style', 'frappe' ),
				'description' => esc_html__( 'Define responsive styles for h2 heading', 'frappe' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h2_3 = frappe_elated_add_admin_row(
			array(
		...
		//H3
		$group_responsive3_heading_h3 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h3',
				'title'       => esc_html__( 'H3 Responsive Style', 'frappe' ),
				'description' => esc_html__( 'Define responsive styles for h3 heading', 'frappe' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h3_3 = frappe_elated_add_admin_row(
			array(
		...
		//H4
		$group_responsive3_heading_h4 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h4',
				'title'       => esc_html__( 'H4 Responsive Style', 'frappe' ),
				'description' => esc_html__( 'Define responsive styles for h4 heading', 'frappe' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h4_3 = frappe_elated_add_admin_row(
			array(
		...
		//H5
		$group_responsive3_heading_h5 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h5',
				'title'       => esc_html__( 'H5 Responsive Style', 'frappe' ),
				'description' => esc_html__( 'Define responsive styles for h5 heading', 'frappe' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h5_3 = frappe_elated_add_admin_row(
			array(
		...
		//H6
		$group_responsive3_heading_h6 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h6',
				'title'       => esc_html__( 'H6 Responsive Style', 'frappe' ),
				'description' => esc_html__( 'Define responsive styles for h6 heading', 'frappe' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h6_3 = frappe_elated_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings = frappe_elated_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings',
				'title' => esc_html__( 'Headings Responsive (Tablet Portrait View)', 'frappe' )
			)
		);
		
		//H1
		$group_responsive_heading_h1 = frappe_elated_add_admin_group(
			array(
		...
		$row_responsive_heading_h1_1 = frappe_elated_add_admin_row(
			array(
		...
		//H2
		$group_responsive_heading_h2 = frappe_elated_add_admin_group(
			array(
		...
		$row_responsive_heading_h2_1 = frappe_elated_add_admin_row(
			array(
		...
		//H3
		$group_responsive_heading_h3 = frappe_elated_add_admin_group(
			array(
		...
		$row_responsive_heading_h3_1 = frappe_elated_add_admin_row(
			array(
		...
		//H4
		$group_responsive_heading_h4 = frappe_elated_add_admin_group(
			array(
		...
		$row_responsive_heading_h4_1 = frappe_elated_add_admin_row(
			array(
		...
		//H5
		$group_responsive_heading_h5 = frappe_elated_add_admin_group(
			array(
		...
		$row_responsive_heading_h5_1 = frappe_elated_add_admin_row(
			array(
		...
		//H6
		$group_responsive_heading_h6 = frappe_elated_add_admin_group(
			array(
		...
		$row_responsive_heading_h6_1 = frappe_elated_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings2 = frappe_elated_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings2',
				'title' => esc_html__( 'Headings Responsive (Mobile Devices)', 'frappe' )
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = frappe_elated_add_admin_group(
			array(
		...
		$row_responsive2_heading_h1_1 = frappe_elated_add_admin_row(
			array(
		...
		//H2
		$group_responsive2_heading_h2 = frappe_elated_add_admin_group(
			array(
		...
		$row_responsive2_heading_h2_1 = frappe_elated_add_admin_row(
			array(
		...
		//H3
		$group_responsive2_heading_h3 = frappe_elated_add_admin_group(
			array(
		...
		$row_responsive2_heading_h3_1 = frappe_elated_add_admin_row(
			array(
		...
		//H4
		$group_responsive2_heading_h4 = frappe_elated_add_admin_group(
			array(
		...
		$row_responsive2_heading_h4_1 = frappe_elated_add_admin_row(
			array(
		...
		//H5
		$group_responsive2_heading_h5 = frappe_elated_add_admin_group(
			array(
		...
		$row_responsive2_heading_h5_1 = frappe_elated_add_admin_row(
			array(
		...
		//H6
		$group_responsive2_heading_h6 = frappe_elated_add_admin_group(
			array(
		...
		$row_responsive2_heading_h6_1 = frappe_elated_add_admin_row(
			array(
		 ...
		 * Text
		 */
		$panel_text = frappe_elated_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_text',
				'title' => esc_html__( 'Text', 'frappe' )
			)
		);
		
		$group_text = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_text',
				'title'       => esc_html__( 'Paragraph', 'frappe' ),
				'description' => esc_html__( 'Define styles for paragraph text', 'frappe' ),
				'parent'      => $panel_text
			)
		);
		
		$row_text_1 = frappe_elated_add_admin_row(
			array(
				'name'   => 'row_text_1',
				'parent' => $group_text
			)
		...
		$row_text_2 = frappe_elated_add_admin_row(
			array(
				'name'   => 'row_text_2',
				'parent' => $group_text,
				'next'   => true
		...
		$group_text_res1 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_text_res1',
				'title'       => esc_html__( 'Paragraph Responsive (Table Portrait View)', 'frappe' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for table devices - portrait view', 'frappe' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_1 = frappe_elated_add_admin_row(
			array(
				'name'   => 'row_text_1',
		...
		$group_text_res2 = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_text_res2',
				'title'       => esc_html__( 'Paragraph Responsive (Mobile Devices)', 'frappe' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for mobile devices', 'frappe' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_2 = frappe_elated_add_admin_row(
			array(
				'name'   => 'row_res_text_2',
		...
		$group_link = frappe_elated_add_admin_group(
			array(
				'name'        => 'group_link',
				'title'       => esc_html__( 'Links', 'frappe' ),
				'description' => esc_html__( 'Define styles for link text', 'frappe' ),
				'parent'      => $panel_text
			)
		);
		
		$row_link_1 = frappe_elated_add_admin_row(
			array(
				'name'   => 'row_link_1',
				'parent' => $group_link
			)
		...
		frappe_elated_add_admin_field(
			array(
				...
				'name'          => 'link_color',
				'default_value' => '',
				'label'         => esc_html__( 'Link Color', 'frappe' ),
				'parent'        => $row_link_1
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover Link Color', 'frappe' ),
				'parent'        => $row_link_1
			)
		);
		
		$row_link_2 = frappe_elated_add_admin_row(
			array(
				'name'   => 'row_link_2',
				'parent' => $group_link,
				'next'   => true
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Link Decoration', 'frappe' ),
				'options'       => frappe_elated_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hovel Link Decoration', 'frappe' ),
				'options'       => frappe_elated_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
	...
	add_action( 'frappe_elated_action_options_map', 'frappe_elated_fonts_options_map', 11 );
}