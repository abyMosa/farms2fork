...
class FrappeElatedClassSimpleLineIcons implements iFrappeElatedInterfaceIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'frappe'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'frappe'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'frappe'),
            'icon-social-facebook'    => esc_html__('Facebook', 'frappe'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'frappe'),
            'icon-social-github'      => esc_html__('Github', 'frappe'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'frappe'),
            'icon-social-instagram'   => esc_html__('Instagram', 'frappe'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'frappe'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'frappe'),
            'icon-social-reddit'      => esc_html__('Reddit', 'frappe'),
            'icon-social-skype'       => esc_html__('Skype', 'frappe'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'frappe'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'frappe'),
            'icon-social-spotify'     => esc_html__('Spotify', 'frappe'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'frappe'),
            'icon-social-twitter'     => esc_html__('Twitter', 'frappe'),
            'icon-social-youtube'     => esc_html__('Youtube', 'frappe')
        );
    }
