...
if ( ! function_exists('frappe_elated_contact_form_7_options_map') ) {

	function frappe_elated_contact_form_7_options_map() {
		
		frappe_elated_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'frappe' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = frappe_elated_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'frappe' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = frappe_elated_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'frappe' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'frappe' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = frappe_elated_add_admin_row(
			array(
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'frappe' ),
			)
		);
		...
		$typography_text_row2 = frappe_elated_add_admin_row(
			array(
		...
		$typography_text_row3 = frappe_elated_add_admin_row(
			array(
		...
		$typography_label_group = frappe_elated_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'frappe' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'frappe' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = frappe_elated_add_admin_row(
			array(
		...
		$typography_label_row2 = frappe_elated_add_admin_row(
			array(
		...
		$background_border_group = frappe_elated_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'frappe' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'frappe' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = frappe_elated_add_admin_row(
			array(
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'frappe' )
			)
		);
		
		$background_border_row2 = frappe_elated_add_admin_row(
			array(
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'frappe' ),
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'frappe' )
			)
		);
		
		$background_border_row3 = frappe_elated_add_admin_row(
			array(
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'frappe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'frappe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = frappe_elated_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'frappe' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = frappe_elated_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'frappe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'frappe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'frappe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'frappe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = frappe_elated_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'frappe' ),
				'description' => esc_html__( 'Setup form elements margin', 'frappe' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = frappe_elated_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'frappe' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'frappe' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = frappe_elated_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'frappe' ),
				'description' => esc_html__( 'Setup button text typography', 'frappe' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = frappe_elated_add_admin_row(
			array(
		...
		frappe_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Hover Text Color', 'frappe' )
			)
		);
		...
		$button_typography_row2 = frappe_elated_add_admin_row(
			array(
		...
		$button_background_border_group = frappe_elated_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'frappe' ),
				'description' => esc_html__( 'Setup button background and border style', 'frappe' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = frappe_elated_add_admin_row(
			array(
		...
		frappe_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'frappe' )
			)
		);
		
		$button_background_border_row2 = frappe_elated_add_admin_row(
			array(
		...
		frappe_elated_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'frappe' )
			)
		);
		
		$button_background_border_row3 = frappe_elated_add_admin_row(
			array(
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'frappe' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'frappe' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = frappe_elated_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'frappe')
		));

		//Text Typography

		$typography_text_group = frappe_elated_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'frappe'),
			'description'	=> esc_html__('Setup typography for form elements text', 'frappe'),
		...
		$typography_text_row1 = frappe_elated_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = frappe_elated_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = frappe_elated_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = frappe_elated_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'frappe'),
			'description'	=> esc_html__('Setup typography for form elements label', 'frappe'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = frappe_elated_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = frappe_elated_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = frappe_elated_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'frappe'),
			'description'	=> esc_html__('Setup form elements background and border style', 'frappe'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = frappe_elated_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = frappe_elated_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = frappe_elated_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = frappe_elated_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'frappe'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = frappe_elated_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = frappe_elated_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'frappe'),
			'description'	=> esc_html__('Setup form elements margin', 'frappe'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = frappe_elated_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = frappe_elated_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'frappe'),
			'description'	=> esc_html__('Setup button text typography', 'frappe'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = frappe_elated_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = frappe_elated_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = frappe_elated_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'frappe'),
			'description'	=> esc_html__('Setup button background and border style', 'frappe'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = frappe_elated_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = frappe_elated_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = frappe_elated_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = frappe_elated_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'frappe')
        ));
        ...
        $typography_label_row3 = frappe_elated_add_admin_row(array(
        ...
        $button_typography_row3 = frappe_elated_add_admin_row(array(
	...
	add_action( 'frappe_elated_action_options_map', 'frappe_elated_contact_form_7_options_map', 20);
}