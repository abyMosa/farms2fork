...
if( !function_exists('frappe_elated_get_blog_single_holder_classes') ) {
    /**
     * Function that generates blog holder classes for single blog page
     */
    function frappe_elated_get_blog_single_holder_classes($classes) {
    ...
    add_filter( 'frappe_elated_filter_blog_single_holder_classes', 'frappe_elated_get_blog_single_holder_classes' );
}
