...
$blog_list_image_id = ! empty( $image_meta ) && frappe_elated_blog_item_has_link() ? frappe_elated_get_attachment_id_from_url( $image_meta ) : '';
$background_image   = '';
...
?>
<?php if ( $has_featured ) { ?>
	<div class="eltdf-post-image-background" <?php frappe_elated_inline_style($background_image); ?>>
