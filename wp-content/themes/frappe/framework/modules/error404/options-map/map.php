...
if ( ! function_exists( 'frappe_elated_error_404_options_map' ) ) {
	function frappe_elated_error_404_options_map() {
		
		frappe_elated_add_admin_page(
			array(
				'slug'  => '__404_error_page',
				'title' => esc_html__( '404 Error Page', 'frappe' ),
				'icon'  => 'fa fa-exclamation-triangle'
			)
		);
		
		$panel_404_header = frappe_elated_add_admin_panel(
			array(
		...
		frappe_elated_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a border bottom color for header area', 'frappe' )
			)
		);
		...
		$panel_404_options = frappe_elated_add_admin_panel(
			array(
				'page'  => '__404_error_page',
				'name'  => 'panel_404_options',
				'title' => esc_html__( '404 Page Options', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a background image for 404 page', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Pattern Background Image', 'frappe' ),
				'description' => esc_html__( 'Choose a pattern image for 404 page', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Title Image', 'frappe' ),
				'description' => esc_html__( 'Choose a background image for displaying above 404 page Title', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'name'          => '404_title',
				'default_value' => '',
				'label'         => esc_html__( 'Title', 'frappe' ),
				'description'   => esc_html__( 'Enter title for 404 page. Default label is "404".', 'frappe' )
			)
		);
		...
		$first_level_group = frappe_elated_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Title Style', 'frappe' ),
				'description' => esc_html__( 'Define styles for 404 page title', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'name'          => '404_subtitle',
				'default_value' => '',
				'label'         => esc_html__( 'Subtitle', 'frappe' ),
				'description'   => esc_html__( 'Enter subtitle for 404 page. Default label is "PAGE NOT FOUND".', 'frappe' )
			)
		);
		...
		$second_level_group = frappe_elated_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Subtitle Style', 'frappe' ),
				'description' => esc_html__( 'Define styles for 404 page subtitle', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'name'          => '404_text',
				'default_value' => '',
				'label'         => esc_html__( 'Text', 'frappe' ),
				'description'   => esc_html__( 'Enter text for 404 page.', 'frappe' )
			)
		);
		...
		$third_level_group = frappe_elated_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Text Style', 'frappe' ),
				'description' => esc_html__( 'Define styles for 404 page text', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Back to Home Button Label', 'frappe' ),
				'description' => esc_html__( 'Enter label for "Back to home" button', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Skin', 'frappe' ),
				'description'   => esc_html__( 'Choose a style to make Back to Home button in that predefined style', 'frappe' ),
				'options'       => array(
					''            => esc_html__( 'Default', 'frappe' ),
					'light-style' => esc_html__( 'Light', 'frappe' )
				)
			)
		);
	}
	
	add_action( 'frappe_elated_action_options_map', 'frappe_elated_error_404_options_map', 19 );
}