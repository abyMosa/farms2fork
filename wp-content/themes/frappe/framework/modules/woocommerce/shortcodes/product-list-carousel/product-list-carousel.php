...
namespace FrappeCore\CPT\Shortcodes\ProductListCarousel;
...
class ProductListCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List - Carousel', 'frappe' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'frappe' ),
							'value'       => array(
							...
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'frappe' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'frappe' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'frappe' ),
							'value'       => array_flip( frappe_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'frappe' )
						),
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'frappe' ),
							'description' => esc_html__( 'Default value is 5000 (ms)', 'frappe' ),
							'group'       => esc_html__( 'Slider Settings', 'frappe' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'slider_speed_animation',
							'heading'     => esc_html__( 'Slide Animation Duration', 'frappe' ),
							'description' => esc_html__( 'Speed of slide animation in milliseconds. Default value is 600.', 'frappe' ),
							'group'       => esc_html__( 'Slider Settings', 'frappe' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_navigation',
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'frappe' ),
							'value'       => array_flip( frappe_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'frappe' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Navigation Skin', 'frappe' ),
							'value'      => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'frappe' ),
							'value'       => array_flip( frappe_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'frappe' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Skin', 'frappe' ),
							'value'      => array(
								esc_html__( 'Default', 'frappe' ) => 'default',
								esc_html__( 'Light', 'frappe' )   => 'light'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Position', 'frappe' ),
							'value'      => array(
								esc_html__( 'Below Carousel', 'frappe' )  => 'bellow-slider',
								esc_html__( 'Inside Carousel', 'frappe' ) => 'inside-slider'
							),
							'dependency' => array( 'element' => 'slider_pagination', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Slider Settings', 'frappe' )
						),
	...
	public function render( $atts, $content = null ) {
		...
		$html = frappe_elated_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list-carousel', $params['type'], $params, $additional_params );
