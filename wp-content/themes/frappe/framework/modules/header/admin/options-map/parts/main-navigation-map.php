...
if ( ! function_exists( 'frappe_elated_get_hide_dep_for_header_main_menu_options' ) ) {
	function frappe_elated_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'frappe_elated_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'frappe_elated_header_main_navigation_options_map' ) ) {
	function frappe_elated_header_main_navigation_options_map() {
		$hide_dep_options = frappe_elated_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = frappe_elated_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'frappe' ),
		...
		frappe_elated_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'frappe' )
			)
		);
		
		$drop_down_group = frappe_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'frappe' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'frappe' )
			)
		);
		
		$drop_down_row1 = frappe_elated_add_admin_row(
			array(
		...
		frappe_elated_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'frappe' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'frappe' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'frappe' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'frappe' )
				)
			)
		);
		...
		$first_level_group = frappe_elated_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Active Text Color', 'frappe' ),
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'frappe' ),
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'frappe' ),
			)
		);
		
		$first_level_row4 = frappe_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'frappe' ),
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'frappe' ),
			)
		);
		
		$first_level_row5 = frappe_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = frappe_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = frappe_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'frappe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'frappe' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = frappe_elated_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'frappe' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'frappe' )
			)
		);
		...
		frappe_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'frappe' )
			)
		);
		...
		$second_level_wide_group = frappe_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'frappe' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'frappe' )
			)
		);
		
		$second_level_wide_row1 = frappe_elated_add_admin_row(
			array(
		...
		$second_level_wide_row2 = frappe_elated_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = frappe_elated_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = frappe_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_group',
				'title'       => esc_html__( '3nd Level Menu', 'frappe' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'frappe' )
			)
		);
		
		$third_level_row1 = frappe_elated_add_admin_row(
			array(
		...
		$third_level_row2 = frappe_elated_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_row3 = frappe_elated_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = frappe_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'frappe' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'frappe' )
			)
		);
		
		$third_level_wide_row1 = frappe_elated_add_admin_row(
			array(
		...
		$third_level_wide_row2 = frappe_elated_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = frappe_elated_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'frappe_elated_action_header_main_navigation_options_map', 'frappe_elated_header_main_navigation_options_map', 10, 1 );
}