...
(function($) {
    ...
    */
    function eltdfOnWindowLoad() {
	    ...
	    eltdfParallaxBackgroundOverlay();
	    eltdfCutOfRowPosition();
    }
    ...
    */
                ...
                searchField.on('keyup paste', function() {
                    ...
                    keyPressTimeout = setTimeout( function() {
                        ...
                        if(searchTerm.length < 3) {
                            ...
                            var ajaxData = {
                                action: 'frappe_elated_search_post_types',
                                term: searchTerm,
                                postType: postType
                            };
	...
	function eltdfParallaxBackgroundOverlay() {
		$('.eltdf-overlay-parallax-background').parent().css('position', 'relative');
	}

	function eltdfCutOfRowPosition() {
		$('.eltdf-cut-off-effect').parent().css('position', 'relative');
	}
    ...
    function eltdfParallaxElements() {
        var parallaxIntances = $('.eltdf-parallax-holder');
	...
	function eltdfInitBlogPagination(){
		...
		var initMainPagFunctionality = function(thisHolder) {
			...
			if(nextPage <= maxNumPages){
				...
				var ajaxData = eltdf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'frappe_elated_blog_load_more');
		...
		menu_items.each(function() {
			...
			if(thisItem.find('.second').length) {
				thisItem.waitForImages(function(){
					...
					if (!eltdf.menuDropdownHeightSet && ! eltdf.body.hasClass('eltdf-dropdown-default')) {
					...
					if(navigator.userAgent.match(/(iPod|iPhone|iPad)/)) {
						...
						if (eltdf.body.hasClass('eltdf-dropdown-animate-height')) {
							...
							var config = {
								...
								over: function () {
									setTimeout(function () {
										dropDownHolder.addClass('eltdf-drop-down-start');
									}, 150);
								},
								timeout: 150,
								out: function () {
    ...
    function eltdfInitBlogListShortcodePagination(){
        ...
        var initMainPagFunctionality = function(thisHolder, pagedLink) {
            ...
            if(nextPage <= maxNumPages){
                ...
                var ajaxData = eltdf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'frappe_elated_blog_shortcode_load_more');
